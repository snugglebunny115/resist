...
until [ 'trump' = 'jailed' ]; do
	...
	#question 1
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=33'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=34'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=35'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=36'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=37'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=38'"

	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=63'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=64'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=65'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=66'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=67'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=68'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=69'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=70'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=71'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=72'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=73'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=74'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=75'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=76'"
	QBODY="$QBODY -F 'submitted[cabinet_agencies][]=146'"

	QBODY="$QBODY -F 'submitted[select_other_agencies_boards_and_commissions_select_as_many_as_applicable][]=33'"
	QBODY="$QBODY -F 'submitted[select_other_agencies_boards_and_commissions_select_as_many_as_applicable][]=36'"
	#comments
	QBODY="$QBODY -F 'submitted[reform_comments]='"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=33'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=34'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=35'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=36'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=37'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=38'"

	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=63'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=64'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=65'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=66'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=67'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=68'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=69'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=70'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=71'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=72'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=73'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=74'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=75'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=76'"
	QBODY="$QBODY -F 'submitted[select_agencies_or_programs][]=146'"
